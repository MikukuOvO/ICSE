...
TRAFFIC_TYPE="changing" # CHANGE THIS VALUE (e.g., "bursty", "constant")
# --- End Configuration ---

# --- Derived Variables (Do not change unless structure changes) ---
TRAFFIC_FILE_BASENAME="${TRAFFIC_TYPE}.py"
TRAFFIC_FILE_PATH="traffic_rasing/train-ticket/${TRAFFIC_FILE_BASENAME}"
